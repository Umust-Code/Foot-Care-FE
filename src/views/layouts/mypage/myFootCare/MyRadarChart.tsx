import { convertToNameValue, calculateDiseaseAverages } from 'views/layouts/mypage/converter';

import { css } from '@emotion/react';
import { RadarChart } from 'views/components/Chart/RadarChart';
...
function MyRadarChart({ surveyData }: { surveyData: any }) {
  const convertData = convertToNameValue(surveyData);
